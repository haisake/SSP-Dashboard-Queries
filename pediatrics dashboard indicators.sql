...
--------------------------------------
	IF OBJECT_ID('tempdb.dbo.#reportFP_SSPDash') IS NOT NULL DROP TABLE #reportFP_SSPDash;
...
--------------------------------------
	IF OBJECT_ID('tempdb.dbo.#fiscsalQuarters_SSPDash') IS NOT NULL DROP TABLE #fiscsalQuarters_SSPDash;
...
--------------------------------------
	...
	IF OBJECT_ID('tempdb.dbo.#fiscalYears_SSPDash') IS NOT NULL DROP TABLE #fiscalYears_SSPDash;
...
*/
	...
	IF OBJECT_ID('tempdb.dbo.#ID01_RSSPDash') IS NOT NULL DROP TABLE #ID01_RSSPDash;
...
*/
	...
	IF OBJECT_ID('tempdb.dbo.#sspVisits') IS NOT NULL DROP TABLE #sspVisits;
	...
	IF OBJECT_ID('tempdb.dbo.#sspVisitsAllEA') IS NOT NULL DROP TABLE #sspVisitsAllEA;
	...
	IF OBJECT_ID('tempdb.dbo.#sspVisitsAllEA2') IS NOT NULL DROP TABLE #sspVisitsAllEA2;
	...
	IF OBJECT_ID('tempdb.dbo.#sspVisitsLOS') IS NOT NULL DROP TABLE #sspVisitsLOS;
	...
	-------------------------------
	IF OBJECT_ID('tempdb.dbo.#ID04_RSSPDash') IS NOT NULL DROP TABLE #ID04_RSSPDash;
...
*/
	...
	---------------------------------------------
		...
		IF OBJECT_ID('tempdb.dbo.#adtcRSSPAdmits') IS NOT NULL DROP TABLE #adtcRSSPAdmits;
		...
		--transfers in
		---------------
		IF OBJECT_ID('tempdb.dbo.#adtcRSSPTransIN') IS NOT NULL DROP TABLE #adtcRSSPTransIN;
		...
		-------------------------
		IF OBJECT_ID('tempdb.dbo.#consolidateIn') IS NOT NULL DROP TABLE #consolidateIn;
	...
	---------------------------------------------
		...
		--------------------------------------------------------------------------------
		--admits into RSSP are considered as those where the admitted bed is like RSSP%
		IF OBJECT_ID('tempdb.dbo.#adtcRSSPDischarges') IS NOT NULL DROP TABLE #adtcRSSPDischarges;
		...
		--transfers out
		---------------
		IF OBJECT_ID('tempdb.dbo.#adtcRSSPTransOut') IS NOT NULL DROP TABLE #adtcRSSPTransOut;
		...
		IF OBJECT_ID('tempdb.dbo.#consolidateOut') IS NOT NULL DROP TABLE #consolidateOut;
	...
	---------------------------------------------
	IF OBJECT_ID('tempdb.dbo.#ID02_RSSPDash') IS NOT NULL DROP TABLE #ID02_RSSPDash;
	...
	IF OBJECT_ID('tempdb.dbo.#linkedInsOutsRSSP') IS NOT NULL DROP TABLE #linkedInsOutsRSSP;
	...
	IF OBJECT_ID('tempdb.dbo.#ID03_RSSPDash') IS NOT NULL DROP TABLE #ID03_RSSPDash;
...
*/
	...
	----------------------
		...
		IF OBJECT_ID('tempdb.dbo.#ID05_RSSPDash') IS NOT NULL DROP TABLE #ID05_RSSPDash;
	...
	--ID06 Sent to BC Children's
	----------------------
	IF OBJECT_ID('tempdb.dbo.#ID06_RSSPDash') IS NOT NULL DROP TABLE #ID06_RSSPDash;
...
*/
	...
	*/
	...
	TRUNCATE TABLE DSSI.dbo.RSSPDASH_Top10EDDx_CurrentFP
	GO
...
*/
	...
	IF OBJECT_ID('tempdb.dbo.#RRSP_AccountNums_RSSPDash') IS NOT NULL DROP TABLE #RRSP_AccountNums_RSSPDash;
	...
	*/
	...
	TRUNCATE TABLE DSSI.dbo.RSSPDASH_Top10CMG_CurrentFY
	GO
...
--o   12+ years
	...
	*/
	...
	IF OBJECT_ID('tempdb.dbo.#RSSP_PEWS_ED_Counts') IS NOT NULL DROP TABLE #RSSP_PEWS_ED_Counts;
	...
	TRUNCATE TABLE DSSI.dbo.RSSPDASH_PEWSCounts_ED
	GO
...
--o   12+ years
	...
	*/
	...
	--compute # of cases by PEWS age group and store the results
	IF OBJECT_ID('tempdb.dbo.#RSSP_PEWS_Acute_Counts') IS NOT NULL DROP TABLE #RSSP_PEWS_Acute_Counts;
	...
	--clear historical table values
	TRUNCATE TABLE DSSI.dbo.RSSPDASH_PEWSCounts_Acute
	GO
...
*/
	...
	TRUNCATE TABLE DSSI.[dbo].[RSSPDASH_MasterTableAll];
	TRUNCATE TABLE DSSI.[dbo].[RSSPDASH_MasterTableMostRecent];
	GO
